...
/**
 * Klasa przechowująca linki do plików fxml, zawierających sceny.
 */

public class SceneFXML {

    /**
     * Odnośnik do pliku z panelu Osoby odpowiedzialnej za nagrody
     */

    public static final String PANEL_NAGROD = "PanelOsobyOdNagrod";

    /**
     * Odnośnik do pliku z panelu edycji nagród
     */

    public static final String PANEL_EDIT_NAGROD = "PanelEdycjiNagrod";

    /**
     * Odnośnik do pliku z panele logowania
     */
    ...
    /**
     * Odnośnik do pliku z panelem administratora
     */
    ...
    /**
     * Odnośnik do pliku z panelem użytkownika
     */
